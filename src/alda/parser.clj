  ...
  (->> alda-code
       ...
       (insta/transform
         {:name              #(hash-map :name %)
          ...
          :global-attributes #(list* 'global-attributes %&)
          :global-attribute-change #(list* 'global-attribute %&)
          :voice             #(list* 'voice %&)
          :voices            #(list* 'voices %&)
          :marker            #(list  'marker %)
          :at-marker         #(list  'at-marker %)
          :music-data        #(list* 'music-data %&)
          :instrument-call   #(list* 'instrument-call %&)
          :alda-score        #(list* 'alda-score %&)})))
